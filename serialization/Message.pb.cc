...
const uint32_t TableStruct_Message_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::yi::MsgHeader, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::yi::MsgHeader, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::yi::MsgHeader, msg_size_),
  0,
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 7, -1, sizeof(::yi::MsgHeader)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::yi::_MsgHeader_default_instance_),
};

const char descriptor_table_protodef_Message_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\rMessage.proto\022\002yi\"\035\n\tMsgHeader\022\020\n\010msg_"
  "size\030\001 \002(\r"
  ;
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_Message_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_Message_2eproto = {
  false, false, 50, descriptor_table_protodef_Message_2eproto, "Message.proto", 
...
class MsgHeader::_Internal {
 public:
  ...
  static void set_has_msg_size(HasBits* has_bits) {
    (*has_bits)[0] |= 1u;
  }
...
MsgHeader::MsgHeader(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:yi.MsgHeader)
}
MsgHeader::MsgHeader(const MsgHeader& from)
  ...
  // @@protoc_insertion_point(copy_constructor:yi.MsgHeader)
}
...
MsgHeader::~MsgHeader() {
  // @@protoc_insertion_point(destructor:yi.MsgHeader)
...
// @@protoc_insertion_point(message_clear_start:yi.MsgHeader)
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ...
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      // required uint32 msg_size = 1;
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 8)) {
          _Internal::set_has_msg_size(&has_bits);
...
uint8_t* MsgHeader::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:yi.MsgHeader)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (cached_has_bits & 0x00000001u) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32ToArray(1, this->_internal_msg_size(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:yi.MsgHeader)
  return target;
}

size_t MsgHeader::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:yi.MsgHeader)
  size_t total_size = 0;

  // required uint32 msg_size = 1;
  if (_internal_has_msg_size()) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt32SizePlusOne(this->_internal_msg_size());
  }
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_merge_from_start:yi.MsgHeader)
  GOOGLE_DCHECK_NE(&from, this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;

  if (from._internal_has_msg_size()) {
...
// @@protoc_insertion_point(class_specific_copy_from_start:yi.MsgHeader)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::yi::MsgHeader* Arena::CreateMaybeMessage< ::yi::MsgHeader >(Arena* arena) {
  return Arena::CreateMessageInternal< ::yi::MsgHeader >(arena);
}
