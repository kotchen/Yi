...
PROTOBUF_NAMESPACE_OPEN
template<> ::yi::MsgHeader* Arena::CreateMaybeMessage<::yi::MsgHeader>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace yi {
...
class MsgHeader final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:yi.MsgHeader) */ {
 public:
  ...
  bool has_msg_size() const;
  private:
  bool _internal_has_msg_size() const;
  public:
  void clear_msg_size();
  ...
  // @@protoc_insertion_point(class_scope:yi.MsgHeader)
 private:
  class _Internal;
...
// required uint32 msg_size = 1;
inline bool MsgHeader::_internal_has_msg_size() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool MsgHeader::has_msg_size() const {
  return _internal_has_msg_size();
}
inline void MsgHeader::clear_msg_size() {
  msg_size_ = 0u;
  _has_bits_[0] &= ~0x00000001u;
}
inline uint32_t MsgHeader::_internal_msg_size() const {
  return msg_size_;
}
inline uint32_t MsgHeader::msg_size() const {
  // @@protoc_insertion_point(field_get:yi.MsgHeader.msg_size)
  return _internal_msg_size();
}
inline void MsgHeader::_internal_set_msg_size(uint32_t value) {
  _has_bits_[0] |= 0x00000001u;
  msg_size_ = value;
}
inline void MsgHeader::set_msg_size(uint32_t value) {
  _internal_set_msg_size(value);
  // @@protoc_insertion_point(field_set:yi.MsgHeader.msg_size)
}
